      ...
      <div class="col-md-6 col-md-offset-3">
        <form v-on:submit.prevent="bla" class="form-horizontal">
            <fieldset>
                ...
                <input v-model="formQ.title" class="form-control" type="text" id="titleQ" placeholder="title" required></input><br>  
                <label class="pull-left"> Description: </label>
                <textarea v-model="formQ.content" class="form-control" type="text" placeholder="Question Description" required></textarea><br>
            </fieldset>
        </form>
    </div>
  </div>
